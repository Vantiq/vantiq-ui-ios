...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/vantiq-sdk-ios/vantiq_sdk_ios.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/vantiq-ui-ios/vantiq_ui_ios.framework"
fi
